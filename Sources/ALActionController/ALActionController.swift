...
public struct ALStyles
{
	public let itemStyles: ALItemStyles
	public let backgroundColor: UIColor
	public let contentInsets: UIEdgeInsets
	public let sectionInsets: UIEdgeInsets

	public init(
		itemStyles: ALItemStyles = .init(),
...
final class ALActionCollectionViewCell: UICollectionViewCell
{
	enum Position
	{
		case one
...
public final class ALActionController: UIViewController
{
	private var actions = [ALAction]()
	private let styles: ALStyles
	...
	private lazy var collectionView: UICollectionView = {
		...
		collectionView.register(
			ALActionCollectionViewCell.self,
			forCellWithReuseIdentifier: String(describing: ALActionCollectionViewCell.self)
		)
		collectionView.register(
			ALActionCollectionViewCell.self,
			forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter,
			withReuseIdentifier: String(describing: ALActionCollectionViewCell.self)
		)
...
extension ALActionController: UICollectionViewDataSource
{
